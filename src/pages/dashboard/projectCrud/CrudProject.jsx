...
export default function CrudProject() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    formData.append(
      "requestDate",
      new Date(editProject.requestDate).toISOString().slice(0, -1) + "Z"
    );
    formData.append(
      "realisationDate",
      new Date(editProject.realisationDate).toISOString().slice(0, -1) + "Z"
    );
    if (editProject.file) {
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditProject({ ...editProject, typeId: e.target.value })
                  }
                  className="border border-gray-300 p-2 rounded w-full"
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditProject({ ...editProject, userId: e.target.value })
                  }
                  className="border border-gray-300 p-2 rounded w-full"
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditProject({ ...editProject, status: e.target.checked })
                  }
                  className="p-2"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  type="datetime-local"
                  value={new Date(editProject.requestDate)
                    .toISOString()
                    .slice(0, 16)}
                  onChange={(e) =>
                    setEditProject({
              ...
              <div className="mb-4">
                ...
                <input
                  type="datetime-local"
                  value={new Date(editProject.realisationDate)
                    .toISOString()
                    .slice(0, 16)}
                  onChange={(e) =>
                    setEditProject({
