...
import bgImg from "../../../assets/images/singUptBg.png";
import loginBg from "../../../assets/images/singInBg.png";
    ...
    <>
      ...
      <div
        style={{
          ...
          backgroundSize: "100%", // Ajuste la taille de l'image pour couvrir tout le conteneur
      ...
      >
        <div
          style={{
            ...
            backgroundColor: "#d3c9e6",
            border: "#5a189a solid 4px",
          }}
        >
          <input
            type="checkbox"
