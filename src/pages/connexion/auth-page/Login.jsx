        ...
        >
          ...
          >
            ...
            <Grid container justifyContent={'center'}>
              <Link to={"/connexion"} >
                <Typography color={PALETTE_COLORS.second} sx={{textDecoration:"underline"}} variant="body2" fontWeight={'bold'}>Hanokatra kanonty</Typography>
              </Link>
            </Grid>
            <Grid container justifyContent={'center'}>
              <Link to={"/"} >
                <Typography color={PALETTE_COLORS.second} sx={{textDecoration:"underline"}} variant="body2" >Hiverina</Typography>
              </Link>
            </Grid>
          </div>
        </div>
